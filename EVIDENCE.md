...
| **Deployment Transaction** | `0x795e492c90802447bd64ce0fc6d2003a0f115b90146fe632df9e74604341c58a` | [`evidence/intergration/deployment-evidence/deployment-evidence.md`](evidence/intergration/deployment-evidence/deployment-evidence.md), [`evidence/intergration/deployment-evidence/transaction-evidence.txt`](evidence/intergration/deployment-evidence/transaction-evidence.txt) |
| **Deployment Block** | `11557021` | [`evidence/intergration/deployment-evidence/deployment-evidence.md`](evidence/intergration/deployment-evidence/deployment-evidence.md), [`evidence/intergration/deployment-evidence/transaction-evidence.txt`](evidence/intergration/deployment-evidence/transaction-evidence.txt) |
| **Solidity Compiler** | `0.8.34` (`0.8.34+commit.80d5c536`) | [`evidence/intergration/deployment-evidence/compiler-setting.txt`](evidence/intergration/deployment-evidence/compiler-setting.txt) |
| **EVM Version** | `Osaka` (`default (osaka)`) | [`evidence/intergration/deployment-evidence/compiler-setting.txt`](evidence/intergration/deployment-evidence/compiler-setting.txt) |
| **Optimizer** | `Disabled / Off` (Tắt) | [`evidence/intergration/deployment-evidence/compiler-setting.txt`](evidence/intergration/deployment-evidence/compiler-setting.txt), [`evidence/intergration/deployment-evidence/deployment-evidence.md`](evidence/intergration/deployment-evidence/deployment-evidence.md) |
...
- **Ca 8 & Ca 9 (Metadata Tampering & Missing Metadata):**
  - [`evidence/e2e/e2e-08-tampered-metadata-untrusted.png`](evidence/e2e/e2e-08-tampered-metadata-untrusted.png)
  - [`evidence/e2e/e2e-09-missing-metadata-unverifiable.png`](evidence/e2e/e2e-09-missing-metadata-unverifiable.png)
...
- **Cấu hình trình biên dịch:** [`evidence/intergration/deployment-evidence/compiler-setting.txt`](evidence/intergration/deployment-evidence/compiler-setting.txt)
- **Biên nhận giao dịch triển khai Sepolia:** [`evidence/intergration/deployment-evidence/transaction-evidence.txt`](evidence/intergration/deployment-evidence/transaction-evidence.txt)
